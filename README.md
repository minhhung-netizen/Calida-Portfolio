...
| `python pipeline/run.py --prices-only` | Lấy bảng giá trong phiên từ DNSE, tự dự phòng bằng Vnstock → cập nhật DB → xuất lại JSON; không gọi Google Sheets |
...
| `portfolio.xlsx / PRICES` | Bảng giá DNSE, tự dự phòng bằng Vnstock (các mã trong POSITIONS và cảnh báo đang bật) | ✅ |
