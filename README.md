...
- **Cảnh báo giá cá nhân**: mỗi người dùng tự tạo ngưỡng tăng đến, giảm đến hoặc một vùng giá và chỉ thấy dữ liệu của chính mình. Có thể chọn gửi một lần, mỗi ngày có giá mới hoặc mỗi lần giá quay lại ngưỡng; chọn giờ gửi sớm nhất và hạn tự hết hiệu lực. Mã ngoài danh mục được bổ sung vào nguồn lấy giá ở lần đồng bộ tiếp theo.
