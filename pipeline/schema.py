...
SCHEMA = {
    "market.xlsx": {
        ...
        "VIEW": {"cols": ["date", "sentiment", "support_lo", "support_hi", "resist_lo", "resist_hi",
                 ...
                 "dates": ["date"], "key": ["date"],
                 "note": "Mỗi ngày 1 dòng. focus_sectors, risks: phân cách dấu phẩy. week_actions: phân cách dấu |"},
    ...
    "flows.xlsx": {
        "INVESTOR_FLOW": {"cols": ["date", "investor", "net_value"],
                          ...
                          "note": "investor: Cá nhân | Tổ chức | Tự doanh | Khối ngoại. net_value: tỷ đồng, mua ròng dương"},
    ...
    "portfolio.xlsx": {
        "POSITIONS": {"cols": ["ticker", "name", "sector", "book", "status", "buy_lo", "buy_hi",
                      ...
                      "note": "status: MUA | NẮM GIỮ | TĂNG TỶ TRỌNG | GIẢM TỶ TRỌNG | THEO DÕI. Giá: nghìn đồng. weight_pct: % NAV"},
    ...
    "funds.xlsx": {
        "FUND_SUMMARY": {"cols": ["period", "fund_code", "fund_name", "nav_bn", "ytd_pct"],
                         "key": ["period", "fund_code"], "note": "period: MM/YYYY. nav_bn: tỷ đồng"},
