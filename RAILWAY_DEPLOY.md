...
- Máy chủ chạy quy trình giá độc lập mặc định mỗi 1 phút trong các khung `PRICE_REFRESH_WINDOWS` từ thứ Hai đến thứ Sáu. Khi đủ hai khóa DNSE, DNSE là nguồn ưu tiên và Vnstock tự làm dự phòng. DNSE gọi tuần tự tối đa 120 lượt/phút; Vnstock giữ giới hạn riêng 18 lượt/phút ở chế độ khách hoặc theo `PRICE_REQUESTS_PER_MINUTE` khi có API key. Nếu quy trình khác đang bận, lượt giá được bỏ qua thay vì dồn hàng đợi.
